...
"locations": {
"henderson-associates-pllc.md": {
	id: "henderson-associates-pllc.md";
  slug: "henderson-associates-pllc";
  body: string;
...
"services": {
"3rd-party-qa-qc.md": {
	id: "3rd-party-qa-qc.md";
  slug: "3rd-party-qa-qc";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"marine-services.md": {
	id: "marine-services.md";
